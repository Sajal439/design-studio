...
const DESIGN_CATEGORIES = [
  {
    ...
    description:
      "Modular layouts, finishes, shutters, hardware, and smart storage ideas.",
  ...
  },
  {
    ...
    description:
      "Sliding and hinged wardrobes designed for clean storage and daily ease.",
  ...
  },
  {
    ...
    description:
      "Compact study corners and work-from-home setups with shelves and drawers.",
  ...
  },
  {
    ...
    description:
      "Professional cabin, workstation, and storage concepts for productive offices.",
  ...
  },
  {
    ...
    description:
      "Warm bedroom concepts with coordinated wardrobes, panels, and headboards.",
...
export default async function Home() {
  ...
  const heroImages = heroDesigns
    .map((d) => getFirstImageUrl(d.images))
          ...
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              <p className="text-base sm:text-lg text-slate-500 leading-relaxed mb-8 max-w-lg mx-auto lg:mx-0">
                Browse interior design inspirations, estimate materials, and get
                quotes — all from Goel Traders, your reliable local supplier.
              </p>
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            <div className="max-w-2xl">
              ...
              <p className="text-lg text-slate-600 leading-relaxed">
                Start with the space you want to design, then browse matching
                ideas on the full designs page.
              </p>
            </div>
            <Link
              href="/designs"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-6">
            {DESIGN_CATEGORIES.map((category) => (
              <Link
                key={category.title}
                href={category.href}
                className="group relative overflow-hidden rounded-[2rem] border border-slate-200 bg-slate-50 p-6 sm:p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-slate-300 hover:shadow-xl hover:shadow-slate-200/60"
              >
                <div
                ...
                <div className="relative z-10 flex h-full md:min-h-56 flex-col">
                  ...
                  <div className="mt-6 md:mt-auto flex items-center justify-between pt-2 md:pt-8">
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-10 md:p-16 text-center shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-extrabold text-white tracking-tight mb-5">
                Know your interior cost <br className="hidden md:block" />
              ...
              <p className="text-base md:text-lg text-slate-300 leading-relaxed mb-10 max-w-2xl mx-auto">
                Enter your furniture dimensions and get an instant cost
                breakdown. Compare Budget, Medium, and Premium material options
                — same calculation method contractors use.
              </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="mb-16 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
              <div className="max-w-2xl">
                ...
                <p className="text-lg text-slate-600 leading-relaxed">
                  Actual projects delivered for homes and spaces across Haryana.
                  Each one shows the kind of materials, finish quality, and
                  execution support customers can expect from our showroom.
                </p>
              </div>
              <Link
                href="/designs"
            ...
            <div className="mt-10 text-center">
              <a
                href={waUrl(
                  "Hi! I saw your real work projects and want to discuss a similar project.",
                )}
                target="_blank"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <p className="text-lg text-slate-600">
              Real reviews from real customers — from Karnal, Panipat, Ambala,
              and beyond.
            </p>
          </div>
            ...
            {TESTIMONIALS.map((t, idx) => (
              ...
              >
                ...
                <div className="flex items-center justify-between mb-5">
                  {t.source === "google" ? (
                    ...
                    <div className="flex items-center gap-1.5 rounded-full bg-[#25D366]/10 border border-[#25D366]/20 px-2.5 py-1">
                      ...
                      <span className="text-[11px] font-semibold text-[#20a355]">
                        via WhatsApp
                      </span>
                    </div>
                  )}
                ...
                <div className="flex items-center gap-3 mt-5 pt-5 border-t border-slate-100">
                  <div
                    className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-full ${t.avatarColor} text-white text-sm font-bold shadow-sm`}
                  >
                    {t.initials}
                  </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-4xl mx-auto">
            ...
            <a
              ...
              className="group flex flex-col items-center gap-4 rounded-[2rem] border border-slate-200 bg-white p-6 sm:p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-slate-300 hover:shadow-xl hover:shadow-slate-200/60"
            >
            ...
            <a
              href={waUrl(
                "Hi! I'm interested in interior materials for my project. Can you help?",
              )}
              target="_blank"
              rel="noopener noreferrer"
              className="group flex flex-col items-center gap-4 rounded-[2rem] border border-slate-200 bg-white p-6 sm:p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#25D366]/40 hover:shadow-xl hover:shadow-green-200/40"
            >
            ...
            <Link
              href="/consultation"
              className="group flex flex-col items-center gap-4 rounded-[2rem] border border-slate-200 bg-white p-6 sm:p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-xl hover:shadow-primary/10"
            >
          ...
          <div className="relative rounded-[3rem] overflow-hidden bg-white border border-slate-100 p-10 md:p-20 text-center">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg text-slate-500 mb-10 max-w-2xl mx-auto">
                Share your room layout or carpenter's material list. Our team
                will reply with exact availability and factory-direct pricing.
              </p>

              <div className="flex flex-col sm:flex-row justify-center gap-4">
                <a
                  href={waUrl(
                    "Hi! I want a material quote for my interior project. I have a list/design ready.",
                  )}
                  target="_blank"
                  rel="noopener noreferrer"
