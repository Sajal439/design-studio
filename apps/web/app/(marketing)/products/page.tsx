...
export const metadata: Metadata = {
  ...
  description:
    "Browse quality plywood, laminates, hardware, adhesives, veneers and edge bands from top brands.",
};

// ── Cached fetchers ────────────────────────────────────────────────────────────

const getProductCategories = unstable_cache(
  async () =>
      ...
      <div className="container mx-auto px-4">
        <div className="mb-10 text-center">
          ...
          <p className="text-lg text-muted-foreground">
            Quality interior materials from trusted brands — plywood, laminates,
            hardware &amp; more.
          </p>
        </div>
